...
const translations = {
    bg: {
        ...
        'vol-stat-years': 'Години доброволство',
        ...
        'contact-page-subtitle': 'Тук сме, за да помогнем и да отговорим на всякакви въпроси',
        'contact-hero-title': 'Свържи се с нас',
        'contact-hero-desc': 'Независимо дали имаш въпроси относно осиновяването, доброволчество или просто искаш да приветстваш, щеди се чуем от теб. Нашият посвещен екип е готов да ти помогне.',
        ...
        'contact-map-text': 'Картата ще се покажа тук',
        ...
        'admin-form-image': 'URL на изображение',
    ...
    en: {
        ...
        'contact-page-subtitle': 'We\'re here to help and answer any questions',
